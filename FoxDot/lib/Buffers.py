...
DESCRIPTIONS = { 'a' : "//Gameboy hihat",    'A' : "Kick dist drum",
                 'b' : "//Noisy beep",       'B' : "Ambient bass",
                 'c' : "Clap",               'C' : "//Choral",
                 'd' : "//Woodblock",        'D' : "Dirty snare",
                 'e' : "//Electro Cowbell",  'E' : "Ringing percussion",
                 'f' : "//Pops",             'F' : "//Trumpet stabs",
                 'g' : "Gabber bass",        'G' : "Gabber kick",
                 'h' : "//Finger snaps",     'H' : "//Clap",
                 'i' : "Indus Hits",         'I' : "Indus ",
                 'j' : "//Whines",           'J' : "//Ambient stabs",
                 'k' : "Kick accoustic",     'K' : "Kick Noiz",
                 'l' : "//Robot noise",      'L' : "Glitch SFX",
                 'm' : "//808 toms",         'M' : "//Acoustic toms",
                 'n' : "Noise",              'N' : "Noisy hits",
                 'o' : "Snare drum",         'O' : "Heavy snare",
                 'p' : "//Tabla",            'P' : "//Tabla long",
                 'q' : "Ambient long",       'Q' : "Ambient stabs",
                 'r' : "//Metal",            'R' : "//Metallic",
                 's' : "Shaker",             'S' : "Tamborine",
                 't' : "Toms",               'T' : "Toms accoustic set",
                 'u' : "Noiz snare",         'U' : "Misc. Fx",
                 'v' : "Sub kick",           'V' : "Hard kick",
                 'w' : "Ambient boom",       'W' : "Distorted kick",
                 'x' : "Kick",               'X' : "Heavy kick",
